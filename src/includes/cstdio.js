...
module.exports = {
  load: function(rt) {
    ...
    _gets = function(rt, _this, charPtr) {
      var destArray, error1, i, j, ref, return_value;
    ...
    _set_pointer_value = function(pointer, value) {
      var error1, error2, i, j, new_value, ref, results, src_array;
      try {
    ...
    _scanf = function() {
      var _this, args, format, i, j, len, matched_values, pchar, rt, val;
      rt = arguments[0], _this = arguments[1], pchar = arguments[2], args = 4 <= arguments.length ? slice.call(arguments, 3) : [];
    ...
    _sscanf = function() {
      var _this, args, format, format_pointer, i, j, len, matched_values, original_input_stream, original_string, original_string_pointer, rt, val;
      rt = arguments[0], _this = arguments[1], original_string_pointer = arguments[2], format_pointer = arguments[3], args = 5 <= arguments.length ? slice.call(arguments, 4) : [];
